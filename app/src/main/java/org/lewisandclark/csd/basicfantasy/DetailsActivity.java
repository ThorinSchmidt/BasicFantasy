...
public class DetailsActivity extends AppCompatActivity implements XPDialog.XPDialogListener {

    static final String TAG = "DetailsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewCharacterXP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DetailsActivity.this.openXPDialog();
            }
        });
